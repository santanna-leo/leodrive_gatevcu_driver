...
/* #define DRIVEDB_USE_BITS_SIGNAL */
...
/* #define DRIVEDB_USE_DIAG_MONITORS */


/* ------------------------------------------------------------------------- *
  When monitor using is enabled (DRIVEDB_USE_DIAG_MONITORS) and define below
